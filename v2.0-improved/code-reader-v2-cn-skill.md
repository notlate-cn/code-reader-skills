...
description: 基于认知科学的源代码深度理解助手（中文改进版）。结合精细询问法、自我解释测试和检索练习，帮助真正理解和掌握代码，而非仅仅"看懂"。当用户需要深入理解源代码、学习编程技术、准备技术面试或进行代码审查时使用。触发词："深入分析这段代码"、"帮我理解这个算法"、"解释这个实现原理"、"为什么这样写代码"。
---

# 源代码深度理解分析器 v2.0 (Code Deep Understanding Analyzer - 中文版)

基于认知科学研究的专业代码分析工具，确保真正理解代码，而非产生流畅幻觉。
...
**在开始生成任何分析之前，必须完成以下验证：**

### 自我解释测试 (Self-Explanation Test)
